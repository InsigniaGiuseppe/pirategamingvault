...
import { Twitch, Youtube, Clock, Coins, Play, CheckCircle, ExternalLink, Bomb, AlertCircle, RefreshCw } from 'lucide-react';
import { useSimpleAuth } from '@/hooks/useSimpleAuth';
import { useToast } from '@/hooks/use-toast';
import { Progress } from "@/components/ui/progress";
import VideoPlayer from './VideoPlayer';
import OptimizedMinesweeper from './OptimizedMinesweeper';
      ...
      <div className="w-full max-w-4xl mx-auto p-4">
        <Card className="max-w-md mx-auto">
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={retryLoadVideos} className="w-full">
